...
import { ChronikScene } from './scenes/ChronikScene';
...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [MainMenuScene, MapScene, MarketScene, KontorScene, LagerScene, FuhrparkScene, ManagerScene, BankScene, ChronikScene],
