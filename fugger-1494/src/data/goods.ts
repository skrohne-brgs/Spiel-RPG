...
export const GOODS: GoodDef[] = [
  ...
  { id: 'branntwein', name: 'Branntwein', basePrice: 60, volatility: 0.15 },
  ...
  { id: 'arznei', name: 'Arznei', basePrice: 280, volatility: 0.12 },
  { id: 'schmuck', name: 'Schmuck', basePrice: 320, volatility: 0.12 },
];
